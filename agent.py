...
def generate_literature_review_agent(query: str, search_mode: str = "both", model: str = "gpt-4o-mini", history: list = []):
    """
    Parameters:
    ...
    prompt_lines = []
    prompt_lines.append("Please write a detailed literature review based on the following articles' titles and abstracts. Requirements:")
